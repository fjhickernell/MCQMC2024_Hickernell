...
Low discrepancy (LD) sequences, such as lattice, digital, and Halton sequences, are well known to estimate multivariate integrals with greater computational efficiency than independent and identically distributed (IID) sequences.  The use of LD sequences for density estimation has been studied recently %\cite{AbdEtal21a,LEcuyer2022b,LEcPuc20a} 
[1--3].
